...
public class RedCubeM2ClearBalancePlusOne extends SequentialCommandGroup {

    public RedCubeM2ClearBalancePlusOne (SwerveAutoBuilder autoBuilder, PoseEstimator s_poseEstimator) {
