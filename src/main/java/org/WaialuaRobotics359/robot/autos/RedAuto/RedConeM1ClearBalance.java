...
public class RedConeM1ClearBalance extends SequentialCommandGroup {
    ...
    public RedConeM1ClearBalance (SwerveAutoBuilder autoBuilder, PoseEstimator s_poseEstimator) {
        ...
        Pose2d startpose = RedConeM1ClearBalance.get(0).getInitialHolonomicPose();
